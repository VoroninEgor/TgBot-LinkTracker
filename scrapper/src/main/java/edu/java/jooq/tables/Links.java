...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, LocalDateTime> LAST_CHECK = createField(DSL.name("last_check"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("'1970-01-01 00:00:00'"), SQLDataType.LOCALDATETIME)), this, "");
