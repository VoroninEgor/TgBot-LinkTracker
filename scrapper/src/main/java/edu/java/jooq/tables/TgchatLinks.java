...
public class TgchatLinks extends TableImpl<TgchatLinksRecord> {
     ...
     */
    public final TableField<TgchatLinksRecord, Long> TGCHATS_ID = createField(DSL.name("tgchats_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>TGCHAT_LINKS.LINKS_ID</code>.
     */
    public final TableField<TgchatLinksRecord, Long> LINKS_ID = createField(DSL.name("links_id"), SQLDataType.BIGINT.nullable(false), this, "");
